...
import { Shapes, Circle, Square, Triangle, Pentagon, Minus } from "lucide-react";
...
const ShapesComponent = ({ onShapeSelect }: ShapesComponentProps) => {
      ...
      <DialogContent className="bg-white max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="border-t pt-4">
            <h4 className="font-medium mb-2">Create Custom Shapes</h4>
